...
$sql = "INSERT INTO combine (date, name, number, email, location, fees, lash, brow, lenght, paymenttype, balance, balancetype, total )
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<footer>
  ...
  this software  is created  and maintained by hoptec computers . for any assistances contact +234 816 041 9237   
  </div>
  </div>
  </div>
